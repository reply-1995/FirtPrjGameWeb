...
populateMissilePool = (count=10, cooldownTime=10, image='gameImgs/missile.png', speed=8 ) => {
...
populateExplosionPool = (num=10, img='gameImgs/explosion.png', life=10) => {
	let i = 0;
	for (i = 0; i < num; i++) {
...
initializeShip = () => {
	...
	ship.img.src = 'gameImgs/ship.png';
	ship.shield.img.src = 'gameImgs/ship_shield.png';
};
